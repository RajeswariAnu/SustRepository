...
WebUI.setText(findTestObject('Object Repository/Page_LiveSust/input_Crew Colors_color-picker-input w-50 f_89ff85'), 'size')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_LiveSust/a_size'), 0)
