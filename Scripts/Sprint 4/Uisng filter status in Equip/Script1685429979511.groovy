...
WebUI.click(findTestObject('Object Repository/Page_LiveSust/label_Need Replacement'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_LiveSust/span_Need Replacement'))
