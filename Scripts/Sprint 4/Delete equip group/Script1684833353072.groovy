...
WebUI.click(findTestObject('Object Repository/Page_LiveSust/button_Delete'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_LiveSust/div_Equipment group deleted successfully'), 0)
