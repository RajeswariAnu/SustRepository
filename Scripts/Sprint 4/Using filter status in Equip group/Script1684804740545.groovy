...
WebUI.click(findTestObject('Object Repository/Page_LiveSust/label_Archived'))

WebUI.click(findTestObject('Object Repository/Page_LiveSust/th_Status'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_LiveSust/span_Archived'))
