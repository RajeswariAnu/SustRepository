...
WebUI.click(findTestObject('Page_LiveSust/button_Log In'))

WebUI.click(findTestObject('Object Repository/Page_LiveSust/span_Equipment'))

WebUI.setText(findTestObject('Object Repository/Page_LiveSust/input_Crew Colors_color-picker-input w-50 f_89ff85'), 'kjghd')
