...
WebUI.setText(findTestObject('Object Repository/Page_LiveSust/input_Crew Colors_color-picker-input w-50 f_89ff85'), 'jgtkgkt')

WebUI.click(findTestObject('Object Repository/Page_LiveSust/p_No Data Found'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_LiveSust/p_No Data Found'), 0)
