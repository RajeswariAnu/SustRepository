...
WebUI.setText(findTestObject('Object Repository/Page_LiveSust/input_Crew Colors_color-picker-input w-50 f_89ff85'), 'ffjghkf')

WebUI.click(findTestObject('Object Repository/Page_LiveSust/p_No Data Found'))

WebUI.rightClick(findTestObject('Object Repository/Page_LiveSust/p_No Data Found'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_LiveSust/p_No Data Found'))
