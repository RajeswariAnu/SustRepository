...
WebUI.click(findTestObject('Object Repository/Page_LiveSust/a_Crews'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_LiveSust/div_Crew deleted successfully'), 0)
