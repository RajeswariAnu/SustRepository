...
WebUI.click(findTestObject('Object Repository/Page_LiveSust/button_Archive'))

WebUI.click(findTestObject('Object Repository/Page_LiveSust/button_Yes'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_LiveSust/div_Team member archived successfully'))
