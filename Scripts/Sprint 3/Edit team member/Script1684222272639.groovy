...
WebUI.click(findTestObject('Object Repository/Page_LiveSust/button_Update Team Member'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_LiveSust/div_Team member data updated successfully'), 'Team member data updated successfully')
