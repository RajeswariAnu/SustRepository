...
WebUI.setText(findTestObject('Object Repository/Page_LiveSust/textarea_Select_Key Specialties'), 'Key special')

WebUI.click(findTestObject('Object Repository/Page_LiveSust/div_Vaniiiiii Vvhjhuk hgjhu'))

WebUI.click(findTestObject('Object Repository/Page_LiveSust/label_ncxv kjvjkvnjd'))

WebUI.click(findTestObject('Object Repository/Page_LiveSust/button_Update Crew'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_LiveSust/div_Crew updated successfully'), 'Crew updated successfully')
